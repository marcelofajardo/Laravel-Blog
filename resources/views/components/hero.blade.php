<div class="relative">
    <img class="object-cover h-48 w-full rounded" src="https://picsum.photos/id/123/200" alt="cover" />
    <img class="rounded-full h-32 w-32 absolute bottom-0 transform -translate-x-1/2 translate-y-1/2" style="left: 50%"
        src="{{$hero->avatar}}" alt="user" />
</div>
...
<div class="flex justify-between items-start my-4">
    ...
    @auth
    @if ($hero->isOwned())
    <a href="{{$hero->path('edit')}}" class="px-4 py-2 mt-4 text-xs font-semibold text-blue-400
